 ...
 */
public class FrejaBaseTest {
    private static String APPLET_AID = "C5957D86369D";
    private static byte[] APPLET_AID_BYTE = Util.hexStringToByteArray(APPLET_AID);
    private static byte[] INSTALL_DATA_BYTE = Util.hexStringToByteArray("06" + APPLET_AID);
    ...
    public CardManager connect() throws Exception {
        return connect(INSTALL_DATA_BYTE);
    }
    ...
    public CardManager connectRaw(byte[] installData) throws Exception {
        ...
        if (cardType == CardType.REMOTE){
            ...
            runCfg.setAppletToSimulate(FrejaLoA4Applet.class)
    ...
    public FrejaBaseTest setCardType(CardType cardType) {
    ...
    public FrejaBaseTest setSimulateStateful(boolean simulateStateful) {
